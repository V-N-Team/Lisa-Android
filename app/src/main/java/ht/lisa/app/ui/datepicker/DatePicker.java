package ht.lisa.app.ui.datepicker;
...
public class DatePicker extends FrameLayout {
    ...
    DatePicker(ViewGroup root, int numberPickerStyle) {
        ...
        setCurrentLocale(new Locale(LisaApp.getInstance().getLanguage(getContext())));
    ...
    protected void setCurrentLocale(Locale locale) {
        ...
        DateFormatSymbols dateFormatSymbols = DateFormatSymbols.getInstance(new Locale(LisaApp.getInstance().getLanguage(getContext())));
        mShortMonths = dateFormatSymbols.getMonths();
        if (LisaApp.getInstance().isKreyol(getContext())) {
            mShortMonths = new String[]{"Janvye", "Fevriye", "Mas", "Avril", "Me",
